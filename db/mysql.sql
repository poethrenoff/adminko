...
INSERT INTO `block` VALUES (1,1,1,'Текст на главной странице',1),(2,1,3,'Главное меню',4),(3,1,2,'Краткий список новостей',6),(4,3,2,'Полный список новостей',2),(5,3,3,'Главное меню',5),(6,2,1,'Сообщение об ошибке',3);
...
INSERT INTO `block_param` VALUES (5,4,'1'),(5,5,'3'),(3,2,'2'),(3,3,'3'),(4,2,'1'),(4,3,'10'),(6,1,'2'),(1,1,'1'),(2,4,'1'),(2,5,'3');
...
INSERT INTO `layout` VALUES (1,'Шаблон главной страницы','index'),(2,'Шаблон внутренних страниц','default'),(3,'Шаблон для страницы ошибок','simple');
...
INSERT INTO `layout_area` VALUES (1,1,'Контентная область','content',1,1),(2,2,'Контентная область','content',1,1),(3,3,'Контентная область','content',1,1),(4,1,'Главное меню','menu',0,2),(5,2,'Главное меню','menu',0,2),(6,1,'Новостной блок','news',0,3);
...
INSERT INTO `menu` VALUES (1,0,'Главное меню',0,'',1,1),(2,1,'Главная',1,'',1,1),(3,1,'Новости',3,'',2,1),(4,1,'Ссылка',0,'http://adminko.testea.ru/',3,1);
...
INSERT INTO `page` VALUES (1,0,1,'Главная страница','',0,'Заголовок главной страницы','Ключевые слова главной страницы','Описание главной страницы',1,1),(2,1,3,'Ошибка 404','404',0,'Страница не найдена','Страница не найдена','Страница не найдена',2,1),(3,1,2,'Новости','news',0,'Заголовок внутренней страницы','Ключевые слова внутренней страницы','Описание внутренней страницы',1,1);
