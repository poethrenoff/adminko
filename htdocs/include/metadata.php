...
/**/
        ...
        'test' => array(
            ...
            'fields' => array(
                ...
                'test_string' => array('title' => 'Строка', 'type' => 'string', 'main' => 1),
                'test_text' => array('title' => 'Текст', 'type' => 'text', 'errors' => array('require')),
                'test_int' => array('title' => 'Целое', 'type' => 'int', 'errors' => array('require')),
                'test_float' => array('title' => 'Действительное', 'type' => 'float'),
                'test_order' => array( 'title' => 'Порядок', 'type' => 'order'),
                'test_parent' => array( 'title' => 'Родитель', 'type' => 'parent', 'errors' => array('require')),
                'test_table' => array( 'title' => 'Таблица', 'type' => 'table', 'table' => 'news', 'errors' => array('require')),
                'test_image' => array('title' => 'Изображение', 'type' => 'image', 'upload_dir' => 'image'),
                'test_file' => array('title' => 'Файл', 'type' => 'file', 'upload_dir' => 'file', 'errors' => array('require')),
                ...
                'test_datetime' => array('title' => 'Дата/Время', 'type' => 'datetime', 'errors' => array('require')),
                'test_password' => array( 'title' => 'Пароль', 'type' => 'password', 'errors' => array('require')),
            ),
        ),
   );
}
