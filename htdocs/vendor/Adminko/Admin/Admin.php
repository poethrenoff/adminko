...
abstract class Admin extends \Adminko\Object
{
    ...
    {
        $_SESSION[$obj_name] = array_merge($_GET, array('object' => $this->object, 'action' => System::action()),
    ...
    {
        header('Location: ' . System::url_for($this->restore_state($obj_name))); exit;
    }
        ...
        foreach ($object_tree as $object_index => $object_item)
        {
            ...
            if (!is_empty($object_item['object_name']))
                $object_tree[$object_index]['object_url'] = 
                    System::url_for(array('controller' => System::controller(), 'object' => $object_item['object_name']));
        }
